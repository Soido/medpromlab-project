      ...
      <div className="relative cursor-auto inline-block align-middle mx-0 my-auto z-9 text-left w-full ">
        <div className=" opacity-100 translate-y-0 rotate-0">
          <div className="relative animate-flip-up animate-ease-out pt-[70px] pr-0 pb-[50px] xl:pt-[69px] xl:pb-[100px] 2xl:pt-[100px] 2xl:pb-[69px] z-9 bg-white">
            <div
              className=" cursor-pointer w-full sticky top-[94px] mb-[20px]  bg-white/80  z-10"
            ...
            <div className="w-full px-[15px] mx-auto sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1094px]">
              ...
              <div className="mx-auto max-w-none my-0 xl:max-w-[886px] 2xl:max-w-[886px] ">
                <p className="mb-[1.2em] mt-0 text-base">
                  ...
                  сейчас получили широкое распространение импланты из Израиля,
                  Германии, Швейцарии и Южной Кореи. Большой ассортимент
                  имплантационных систем сбивает с толку пациентов, практически
                  все системы имеют схожие черты.
                </p>
                <p className="text-base">
                  Залогом успешной имплантации является четкое следование
                  протоколу. Имплантаты ООО НПК «МЕДПРОМЛАБ» отличаются высоким
                  качеством материалов, множеством инновационных технологий,
                  большим разнообразием моделей, протоколов и имплантационных
                  систем. ООО НПК «МЕДПРОМЛАБ» предлагает собственную разработку
                  - импланты имеют специальное покрытие поверхностей для быстрой
                  и качественной остеоинтеграции. Благодаря специальной форме
                  резьбы, достигается надежная первичная стабилизация, что
                  позволяет сразу устанавливать временный протез.
                </p>
              </div>
                ...
                <div className="relative py-[70px] px-[15px] max-[991px]:py-[50px] before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-sky-100 before:will-change-auto before:text-left ">
                  <div className="relative my-0 mx-auto max-w-none xl:max-w-[886px] 2xl:max-w-[886px] 3xl:max-w-[886px]">
                    <p className="mt-0 mb-[2em] max-[991px]:mb-[1.3em]">
                      ...
                      a text Its a text Its a text Its a text Its a text Its a
                      text Its a text Its a text Its a text Its a text Its a
                      text Its a text Its a text Its a text Its a text Its a
                      text Its a text
                    </p>
                    <p className="mt-0 mb-[2em] max-[991px]:mb-[1.3em]">
...
export default Terumogoreexcluder;
