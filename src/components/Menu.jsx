...
function Menu({ bgColor = 'bg-transparent' }) {
  ...
  return (
    <header
      className={`fixed py-[5px] min-w-[320px] px-0 w-full left-0 top-0 z-10 m-0 ${bgColor}`}
    >
      <div className="relative visible flex flex-wrap items-start my-0 mx-auto py-0 px-[15px] max-w-[1314px]">
        <div className="relative flex w-[50%] items-baseline">
          <button
              ...
              >
                <nav className="text-black text-left no-underline text-2xl font-light ">
                  <ul className="ml-[7.5rem] uppercase">
                    ...
                    <li className=" mb-[1.5rem]">
                      <Link to="/fillingmaterial">Пломбировочный материал</Link>
                    </li>
                    <li className=" mb-[1.5rem]">
                      <Link to="/dentalcare">
                    ...
                    <li className="mb-[1rem]">
                      <Link to="/socialsignicance">Социальная значимость</Link>
                    </li>
                    <li className="mb-[1rem]">
